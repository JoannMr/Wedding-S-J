...
const EventItem: React.FC<{ time: string; title: string; desc: string; isLast?: boolean }> = ({ time, title, desc, isLast }) => (
  <motion.div 
    ...
    className={`flex gap-6 md:gap-10 lg:gap-16 items-start pb-8 md:pb-12 ${!isLast ? 'border-l border-stone-300 ml-3 pl-8 md:pl-12' : 'ml-3 pl-8 md:pl-12'}`}
  >
    <div className="relative">
      <div className="absolute -left-[45px] md:-left-[54px] top-2 w-3 h-3 rounded-full bg-olive-400 ring-4 ring-[#f5f5f4]" />
      <span className="font-sans text-xs font-medium tracking-widest text-olive-600 uppercase">{time}</span>
    </div>
    <div>
      <h3 className="font-serif text-2xl md:text-3xl text-stone-800 mb-2 italic">{title}</h3>
...
export const Details: React.FC = () => {
  return (
    <section id="details" className="py-20 md:py-28 lg:py-32 bg-stone-50 relative">
      <div className="max-w-[1400px] mx-auto px-6 md:px-8 lg:px-12 grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-16 lg:gap-20">
        ...
        <div className="space-y-16">
          <motion.div
             ...
             viewport={{ once: true }}
          >
            <h2 className="font-serif text-4xl md:text-5xl lg:text-7xl text-stone-900 mb-6 md:mb-8">
              Detalles <br/>
              <span className="block text-xl md:text-2xl lg:text-3xl italic text-stone-400 mt-2 font-light">Martes, 24 de Septiembre</span>
            </h2>
          </motion.div>
          ...
          <div className="space-y-6 md:space-y-8">
            <div className="border-t border-stone-200 pt-6 md:pt-8">
              ...
              <p className="font-serif text-xl md:text-2xl text-stone-800">Basílica Santa María del Mar</p>
              <p className="font-sans text-sm text-stone-500 mt-1 font-light">Ceremonia · Barcelona</p>
              <p className="font-serif text-xl md:text-2xl text-stone-800 mt-4 md:mt-6">Castell de Sant Marçal</p>
            ...
            <div className="border-t border-stone-200 pt-6 md:pt-8">
              ...
              <p className="font-serif text-xl md:text-2xl text-stone-800">Formal / Etiqueta</p>
        ...
        {/* Right: Timeline */}
        <div className="bg-white p-6 md:p-10 lg:p-16 shadow-sm border border-stone-100">
